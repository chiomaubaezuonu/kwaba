          ...
          <div className="bg-white rounded-[0.8rem]">
            ...
            <div className="flex flex-col p-6">
              ...
              <div className="flex flex-col bg-pink-400">
                ...
                Veritatis in cumque maiores nostrum. Velit aspernatur blanditiis
                dicta consequatur repellat similique omnis impedit facilis quos
                corrupti nemo, esse officiis veritatis iure magni enim.
                Voluptatibus fuga laborum provident sapiente deleniti eligendi
                sequi cupiditate quis dolorum hic possimus est distinctio
                voluptas esse quaerat libero repellat dicta porro fugiat, id cum
                mollitia nesciunt debitis? Alias reiciendis quibusdam atque,
                quis animi nobis error cupiditate officiis, sed maiores minus?
                Voluptates, aut temporibus sed esse voluptatem a minima id quod
                recusandae officia iste vero harum mollitia nulla velit?
                Similique, sint necessitatibus quam quis dolorem ullam labore
                enim?
              </div>
            </div>
          </div>
