...
import { renterFilterData } from "./pages/RenterScreening";
import { transactionFilterData } from "./pages/Transactions";
...
type AllVerificationStagesType =
  | "Employer Check"
  | "Salary Analysis"
...
interface ContextType {
  ...
  allVerificationStages: boolean // AllVerificationStagesType;
  setAllVerificationStages: React.Dispatch<
   SetStateAction<boolean>
    // SetStateAction<AllVerificationStagesType>
  >;
}
...
export const GlobalProvider: FunctionComponent<{ children: ReactNode }> = ({
  ...
  // const [allVerificationStages, setAllVerificationStages] = useState({
  //   employerCheck: true,
  // });
    const [allVerificationStages, setAllVerificationStages] = useState(true);
  ...
  return (
    <GlobalContext.Provider
      value={{
        ...
        allVerificationStages, 
        setAllVerificationStages,
      }}
    >
      {children}
    </GlobalContext.Provider>
