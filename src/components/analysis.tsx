...
import { verificationSteps } from "../pages/RenterScreeningVerify";
  ...
  return (
    <div className="p-6 rounded-[0.8rem] bg-white text-[#082353]">
      <div className="block mb-6 text-2xl">
        <strong>Employee Verification - </strong> <span> Salary Analysis</span>
      </div>
      ...
      <div className="flex m-6 justify-end">
        <KwabaButton
          onClick={() => setShowSalaryAnalysis(false)}
        ...
        >
          <textarea
            name=""
            id=""
            className="w-full h-44 border border-gray-200"
          ></textarea>
        </Modal>
      </div>
    </div>
