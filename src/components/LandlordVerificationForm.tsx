...
import {
  questions,
  verificationSteps,
} from "../pages/RenterScreeningVerify";
...
const LandlordVerificationForm = () => {
  ...
  const [showrefereeConfirmation, setshowRefereeConfirmation] = useState(false);
      ...
      {showLandlordVerification && (
        <div className="p-6 rounded-[0.8rem] bg- bg-white text-[#082353]">
          ...
          <div className="flex m-6 justify-end mr-0 md:mr-6">
            ...
            <KwabaButton
              onClick={() => {
                setshowRefereeConfirmation(true);
                setShowLandlordVerification(false);
                setShowSalaryAnalysis(false);
                alert("Clicked");
              }}
